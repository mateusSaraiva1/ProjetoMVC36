    ...
    public partial class Form1 : Form
    {
        ...
        private void btn_enviar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cliente.Cpf_cliente = txt_cpfb32.Text.Trim();
                cliente.Nome_cliente = txt_nomeb32.Text.Trim();
                cliente.Nome_mae = txt_nomemaeb32.Text.Trim();
                Double CPF = double.Parse(txt_cpfb32.Text);
